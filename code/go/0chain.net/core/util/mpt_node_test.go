...
func Benchmark_ValueNode_encode(b *testing.B) {
...
func Benchmark_ValueNode_EncodeWithCache(b *testing.B) {
...
func Benchmark_ValueNode_EncodeWithoutCache(b *testing.B) {
	n, _ := prepare(NodeTypeValueNode)
	vn := n.(*ValueNode)
	for i := 0; i < b.N; i++ {
		vn.nc.cached = false
		vn.OriginTracker.(*OriginTracker).cached = false
		vn.Encode()
	}
}

func Benchmark_LeafNode_encode(b *testing.B) {
...
func Benchmark_LeafNode_EncodeWithCache(b *testing.B) {
...
func Benchmark_LeafNode_EncodeWithoutCache(b *testing.B) {
	n, _ := prepare(NodeTypeLeafNode)
	vn := n.(*LeafNode)
	for i := 0; i < b.N; i++ {
		vn.nc.cached = false
...
func Benchmark_FullNode_encode(b *testing.B) {
...
func Benchmark_FullNode_EncodeWithCache(b *testing.B) {
...
func Benchmark_FullNode_EncodeWithoutCache(b *testing.B) {
	n, _ := prepare(NodeTypeFullNode)
	vn := n.(*FullNode)
	for i := 0; i < b.N; i++ {
		vn.nc.cached = false
...
func Benchmark_ExtensionNode_encode(b *testing.B) {
...
func Benchmark_ExtensionNode_EncodeWithCache(b *testing.B) {
...
func Benchmark_ExtensionNode_EncodeWithoutCache(b *testing.B) {
	n, _ := prepare(NodeTypeExtensionNode)
	vn := n.(*ExtensionNode)
	for i := 0; i < b.N; i++ {
		vn.nc.cached = false
...
func Benchmark_msgpack_Decode(b *testing.B) {
	sn := &StorageNodes{}
	sn.Decode(data)
	data := sn.mEncode()
	for i := 0; i < b.N; i++ {
