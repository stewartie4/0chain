...
func ExecuteSmartContract(ctx context.Context, contractObj sci.SmartContractInterface, contract *sci.SmartContract, t *transaction.Transaction, balances c_state.StateContextI) (string, error) {
	if contractObj != nil {
