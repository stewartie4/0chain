...
type MagicBlock struct {
	...
	SignedBlsMessage   string       `json:"signed_bls_message"`
	GroupVvecStr       []string     `json:"groupVvec"`
...
func (mb *MagicBlock) SetupAndInitMagicBlock() (*MagicBlock, error) {
	...
	mgc.DkgDone(mb.SecretKeyGroupStr, mb.RandomSeed, mb.GroupVvecStr)
...
func (mb *MagicBlock) DkgDone(dkgKey string, randomSeed int64, gvvec []string) {

	mb.RandomSeed = randomSeed
	mb.SecretKeyGroupStr = dkgKey
	mb.GroupVvecStr = gvvec
